...
class Redis extends Base
{
    ...
    public function __construct($config)
    {
        ...
        \Swoole\Swoole::getInstance()->beforeAction([$this, '_createObject'],\Swoole\Swoole::coroModuleRedis);
        \Swoole\Swoole::getInstance()->afterAction([$this, '_freeObject'], \Swoole\Swoole::coroModuleRedis);
    }
